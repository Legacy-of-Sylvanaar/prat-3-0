...
--@localization(locale="enUS", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("enUS", L)

--@localization(locale="itIT", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("itIT", L)

--@localization(locale="ptBR", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("ptBR", L)

--@localization(locale="frFR", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("frFR", L)

--@localization(locale="deDE", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("deDE", L)

--@localization(locale="koKR", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("koKR", L)

--@localization(locale="esMX", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("esMX", L)

--@localization(locale="ruRU", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("ruRU", L)

--@localization(locale="zhCN", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("zhCN", L)

--@localization(locale="esES", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("esES", L)

--@localization(locale="zhTW", format="lua_additive_table", handle-subnamespaces="none", same-key-is-true=true, namespace="Substitutions")@
PL:AddLocale("zhTW", L)
end
--@end-non-debug@]===]
